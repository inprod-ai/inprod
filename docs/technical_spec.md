# inprod.ai — Technical Specification
...
This document specifies the technical implementation of inprod.ai's detection and generation systems. It covers:
...
This document specifies exactly how inprod.ai detects and fixes security vulnerabilities, using real examples from Slopometer's own codebase audit.
...
```typescript
// Detector: src/lib/inprod/detectors/security/unencrypted-cookie.ts
...
```typescript
// Generator: src/lib/inprod/generators/security/encrypt-session-cookie.ts
...
// =============================================================================
// Generated by inprod.ai for secure session handling
...
```typescript
// Detector: src/lib/inprod/detectors/security/auth-id-confusion.ts
...
```typescript
// Generator: src/lib/inprod/generators/security/auth-id-fix.ts
...
```typescript
// Detector: src/lib/inprod/detectors/security/ssrf.ts
...
```typescript
// Generator: src/lib/inprod/generators/security/ssrf-protection.ts
...
```typescript
// Detector: src/lib/inprod/detectors/security/security-headers.ts
...
```typescript
// Generator: src/lib/inprod/generators/testing/unit-tests.ts
...
```typescript
// Generator: src/lib/inprod/generators/testing/api-tests.ts
...
```typescript
// Generator: src/lib/inprod/generators/deployment/github-actions.ts
...
function generateCIWorkflow(context: RepoContext): string {
  ...
  return `# =============================================================================
# CI Pipeline - Generated by inprod.ai
# =============================================================================
...
function generateSecurityWorkflow(context: RepoContext): string {
  return `# =============================================================================
# Security Scanning - Generated by inprod.ai
# =============================================================================
...
```typescript
// Generator: src/lib/inprod/generators/documentation/readme.ts
...
### 5.1 Slopometer → inprod.ai Handoff
...
export function CompleteButton({ scan }: CompleteButtonProps) {
  const handleComplete = () => {
    ...
    const signature = signPayload(payload, INPROD_SHARED_SECRET);
    ...
    window.location.href = `https://inprod.ai/complete?${params}`;
  };
...
```typescript
// src/lib/inprod/detectors/stack-detector.ts
...
```typescript
// src/lib/inprod/detectors/security/ios-security.ts
...
```typescript
// src/lib/inprod/generators/testing/xctest.ts
...
```typescript
// src/lib/inprod/generators/deployment/ios-ci.ts
...
export function generateIOSCI(context: RepoContext): GeneratedFile[] {
  ...
  files.push({
    ...
    content: `# =============================================================================
# Fastlane Configuration - Generated by inprod.ai
# =============================================================================
...
`,
  ...
  files.push({
    ...
    content: `# iOS CI - Generated by inprod.ai
name: iOS CI
...
```typescript
// src/lib/inprod/validators/test-validator.ts
...
```typescript
// src/lib/inprod/generators/testing/with-validation.ts
...
├── pkg/
│   └── api/
│       └── client.go         # inprod.ai API client
├── go.mod
└── go.sum
```
...
func main() {
    ...
    // inprod (no args) - analyze current directory
    rootCmd.Run = func(cmd *cobra.Command, args []string) {
        analyze(".")
    }

    // inprod complete - generate all missing
...
See `/src/lib/inprod/templates/` for complete file templates used in generation.
...
| **npx-only CLI** | Assumed `npx inprod` | Added Go CLI architecture for universal support |
